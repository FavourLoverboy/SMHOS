...
<head>
    ...
    <title>Welcome | SMHOS Home-Cell Portal</title>
...
<body class="bg-light">
<?php include('includes/non-members/header.php');  ?>
    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center my-2" style="color: red;"><?php echo $msg ?? "";?></div>  
    ...
    <?php include('includes/non-members/footer.php');  ?>
